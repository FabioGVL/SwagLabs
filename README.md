...
* Uso de `Cypress.env` para gerenciamento de credenciais e parâmetros de teste. Por questões de segurança, apenas o arquivo `env.example` é disponibilizado no repositório, demonstrando a estrutura necessária, sem expor dados reais.
